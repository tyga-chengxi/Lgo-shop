...
import com.lgoshop.portal.config.AlipayConfig;
import com.lgoshop.portal.domain.AliPayParam;
import com.lgoshop.portal.service.AlipayService;
...
public class AlipayController {
    ...
    @ResponseBody
    public LgoResult<String> query(String outTradeNo, String tradeNo){
        return LgoResult.success(alipayService.query(outTradeNo,tradeNo));
    }
}
